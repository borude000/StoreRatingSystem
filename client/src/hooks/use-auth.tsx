...
import { User, InsertUser, UserRole, LoginCredentials, changePasswordSchema } from "@shared/schema";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const changePasswordMutation = useMutation({
    mutationFn: async (passwordData: z.infer<typeof changePasswordSchema>) => {
...
export function useRedirectByRole(user: User | null) {
  if (!user) return "/auth";
